{
  "name": "Winnow",
  "version": "1.0",
  "helpURI": "https://github.com/CyVerse-Validate/Quickstart-Guide/blob/master/docs/Winnow.md",
  "label": "Winnow",
  "defaultQueue": "normal",
  "defaultNodeCount": 1,
  ...
  "executionType": "HPC",
  "parallelism": "SERIAL",
  "deploymentPath": "ksierrac/applications/Winnow1",
  "deploymentSystem": "data.iplantcollaborative.org",
  "templatePath": "wrapper-winnow1.sh",
  "testPath": "test1.sh",
  "checkpointable": true,
  "tags": [
    "python",
