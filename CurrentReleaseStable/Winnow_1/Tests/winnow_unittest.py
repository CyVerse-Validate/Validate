...
class WinnowTest(unittest.TestCase):
    ...
    def test_do_analysis(self):
        ...
        expected = [0.05896121, 0.18211783, -0.03838186, 0.43427679, 0.0, 384.0, 2816.0, 35.0, 0.0, 0.12,
                          0.01081917, 0.12952087, 0.87047913, 0.0, 0.88, 0.0, 1.0, -0.12, -7.77531675]
    ...
    def test_do_gwas(self):
        ...
        a = format_float(self.win.do_gwas('test_filename', score_column, beta_column, None)[1][1:])
        expected = [47.08333333, 5.91666667, 0.16903085, 0.56944444, 4.0, 3.0, 3.0, 2.0, 0.66666667, 0.5, 0.5,
                    0.41666667, 0.58333333, 0.66666667, 0.5, 0.57142857, 0.42857143, 0.16666667, 0.33333185]
