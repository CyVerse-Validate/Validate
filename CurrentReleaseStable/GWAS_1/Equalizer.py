...
betacols = list(args.beta) if args.beta is not None else args.beta
covarcols = list(args.covar) if args.covar is not None else args.covar
...
if verbose:
    print "Beginning column name standardization..."
filelist = os.listdir(folder)
os.chdir(folder)

# Checking requested delimiter
if delimiter == "comma":
    seper=","
else:
    seper = " "
...
for one in filelist:
    ...
    # Checking file endings to ensure appropriate reading
    ...
    # Standardising naming conventions for column headers
